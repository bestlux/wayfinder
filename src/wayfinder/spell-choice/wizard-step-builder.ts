...
import type { BuildWizardSpellChoiceStepsParams } from "./types.js";
...
export function buildWizardSpellChoiceSteps(params: BuildWizardSpellChoiceStepsParams): PendingStep[] {
  const {
    draft,
    currentLevel,
...
function isWizardCurriculumContributor(
  document: BuildWizardSpellChoiceStepsParams["effectiveSchoolDocument"]
): boolean {
