...
The unpublished 0.9.0 candidate adds Bloodrager and Vindicator to the three previously registered class-archetype profiles, with scope through level 5 and Free Archetype disabled. Their Free Archetype combinations require manual GM setup and are not qualified. Candidate qualification and publication status are recorded in the [live smoke log](./beta-readiness-smoke.md). The historical audit evidence below remains separately dated.
