...
export function getPickerInfoState(
  ...
  if (optionCount === 0) {
    ...
    return {
      ...
      message:
        "Nothing in the compendia your world has turned on fits this step. Your GM can enable more content in the Wayfinder settings.",
    };
  }
    ...
    case "heritage":
      return context.ancestrySlug
        ...
        : {
            ...
            message:
              "Heritages branch off your ancestry, so pick that first. Your options will show up here once it's set.",
          };
    case "ancestry-feat":
      return ancestryFeatBlockedState(context);
    case "class-feat":
    ...
    case "class-branch":
      ...
      return context.classSlug
        ...
        : {
            ...
            title: "Choose a class first",
            message:
              "Every class has its own path to choose, a domain, a doctrine, a racket. Pick your class and the right one shows up here.",
          };
    case "deity":
      return context.classSlug
        ? null
    ...
    case "spell-choice":
      if (step.spellChoice?.dependsOn === "class" && !context.classSlug) {
        return {
          ...
          title: "Choose a class first",
          message:
            "Your class decides which tradition you cast from, and that decides your spell list. Pick a class first.",
        };
      }
...
function ancestryFeatBlockedState(context: OptionContext): PickerInfoState | null {
  ...
  return context.classSlug
    ...
    : {
        ...
        title: "Choose a class first",
        message:
          "A few ancestry feats key off class features like spellcasting, so Wayfinder needs your class before it can show the list.",
      };
}
