...
| `titan-mauler-weapon` | The free grant is one weapon for a creature one size larger: melee or ranged, Common or specifically accessed, and base Price at most 9 gp before the size adjustment. It has no resale value before later rune investment. | Player Core 2 p. 75 | Executable funding and eligibility boundary |
