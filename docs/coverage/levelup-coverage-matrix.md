...
| Other spellcasters | Guided when PF2E rule data is structured | Shared caster profiles cover current prepared, spontaneous, bounded, and spellbook choice families through level 5 for deterministic smoke paths. | `.wayfinder-smoke/beta-green-0.1.2-final-3`, spell-choice builder tests | Breadth across alternate subclass-derived traditions, focus spell choices, and later-level branch variants still needs additional matrix rows. |
