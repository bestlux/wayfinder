 ...
 */
export function resolveEquipmentItemLevelBoundary(targetLevel, recipeKind) {
    ...
    return Object.freeze({
        catalogueMaximum: recipeKind === "level-1-equivalent" || recipeKind === "permanent-items" ? targetLevel : belowTargetMaximum,
