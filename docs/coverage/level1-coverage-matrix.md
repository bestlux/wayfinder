...
- Current 0.8.0 candidate feature evidence on 2026-08-21 covers Starting Equipment acquisition, all forced retry boundaries, supported physical grants, actor-size and stack pricing, Adventurer's Pack containment, source isolation, English/Chinese keyboard flows, and two qualifying full catalogue profiles against Foundry VTT 14.366 / PF2E 8.4.1. The exact-candidate full regression and package proof remain pending; see [the smoke log](beta-readiness-smoke.md).
