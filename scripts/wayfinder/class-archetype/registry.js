...
const PALATINE_DETECTIVE = {
    value: "palatine-detective",
    label: "Palatine Detective",
    detail: "Adopt the esoterica methodology. This replaces your normal investigator methodology, grants divine and occult innate cantrips, and requires Palatine Detective Dedication at 2nd level.",
...
export function documentIsWayOfTheSpellshot(document) {
