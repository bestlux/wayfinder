...
- The latest published full-release evidence is 0.8.3 against Foundry VTT 14.366 / PF2E 8.4.1: the 55-execution / 54-scenario matrix and every Starting Equipment overlay passed, including a focused live proof that a level-1 character can find and prepare Healing Potion (Minor). Exact-candidate qualification, package verification, publication, and Foundry registration completed on 2026-08-23; see [the smoke log](beta-readiness-smoke.md#2026-08-23-release-083).
...
| Class archetype selection | Guided for registered profiles | Dedicated class-archetype decision and profile contributor | Battle Creed, Way of the Spellshot, and Palatine Detective are registered. Each affected class retains an explicit Standard choice; unregistered class archetypes stay filtered until their complete progression mechanics are supported. |
...
| Default and upgrade paths | Registered class archetypes | Standard/profile Cleric, Gunslinger, and Investigator; direct and incremental profile actors; Battle Creed conflict fixtures | Choose a registered profile and complete target level 5 | Replaced selector stays hidden, level-2 dedication occupies the reserved class feat, level-4 class feat remains, profile training/spells/grants apply to the correct destination, and rerun has zero pending steps | `.wayfinder-smoke/release-0.4.0-full-4`, class-archetype tests | release |
