function feature(documentId, name, slug) {
    return {
...
function dedication(documentId, name, slug) {
    return {
...
export const BLOODRAGER = {
    value: "bloodrager",
    label: "Bloodrager",
    detail: "Choose the bloodrager instinct, train in Athletics and Medicine, and gain arcane or divine cantrips through the required 2nd-level dedication. Guided through level 5; combining this path with Free Archetype requires manual GM setup.",
...
export const VINDICATOR = {
    value: "vindicator",
    label: "Vindicator",
    detail: "Follow a deity as a vindicator, replacing the standard hunter's edge and Nature training, with divine warden magic and a required 2nd-level dedication. Guided through level 5; combining this path with Free Archetype requires manual GM setup.",
...
//# sourceMappingURL=requested-profiles.js.map