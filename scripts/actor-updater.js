...
async function createSelectedBranchSelector(actor, branch, selection, slotId) {
...
function createBranchSelectorSelection(branch, slotId) {
    return {
        slotId,
...
function stripPreselectedClassBranchEntries(classSource, draft, steps) {
