...
async function loadWayfinderModules(moduleId) {
  const [
    ...
    import(`/modules/${moduleId}/scripts/pack-service.js`),
  ...
  return {
    ...
    fetchSelectionDocument: packService.fetchSelectionDocument,
    ...
    getOptionsForStep: packService.getOptionsForStep,
    ...
    resolveSelection: packService.resolveSelection,
