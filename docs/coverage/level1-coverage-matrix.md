...
- Last published full-regression evidence checked on 2026-08-14: Wayfinder 0.7.3 passed 55 executions representing 54 unique scenarios against Foundry VTT 14.366 and PF2E 8.4.0, with zero classified/manual and zero failed. The matrix includes all-class baselines, seven unique existing-character upgrades, three Free Archetype paths, Ancestry Paragon, Gradual Ability Boosts, five profiles through level 10, Fighter through level 20, and a deliberate late-phase Apply failure/retry. See [the smoke log](beta-readiness-smoke.md).
- Current 0.8.0 candidate evidence on 2026-08-21 covers Starting Equipment acquisition, all forced retry boundaries, supported physical grants, actor-size and stack pricing, Adventurer's Pack containment, source isolation, English/Chinese keyboard flows, two qualifying full catalogue profiles, and the exact-candidate 55-execution regression against Foundry VTT 14.366 / PF2E 8.4.1. Package binding and independent review remain pending; see [the smoke log](beta-readiness-smoke.md).
