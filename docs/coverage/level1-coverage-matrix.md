...
| Starting gear or item purchasing | Not covered | Planned 0.8 acquisition chapter | PF2E-native/manual in 0.7.3. Remaster class kits do not exist as structured data; the planned path is an Adventurer's Pack shortcut plus a running-budget equipment picker. |
