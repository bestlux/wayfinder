...
- Dedicated class-archetype evidence on 2026-07-11: Standard Cleric, direct Battle Creed, incremental Battle Creed level 1 to level 5, both-dedication-skills-trained fallback, actor-owned Toughness fallback, and same-draft Shielded Fortune fallback cases all applied and reran cleanly against Foundry VTT 14.364 and PF2E 8.3.0. Artifact: `.wayfinder-smoke/class-archetype-final-2`.
...
| Class archetype selection | Guided for registered profiles | Dedicated class-archetype decision and profile contributor | Battle Creed is the first registered profile. Standard Cleric remains an explicit choice; unregistered class archetypes stay filtered until their complete progression mechanics are supported. |
...
| Default and upgrade paths | Cleric Battle Creed | Blank Cleric, incremental Battle Creed Cleric, both dedication skills trained, actor with Toughness, or Shielded Fortune draft | Choose Battle Creed and complete target level 5 | Dedicated profile replaces Doctrine, reserves the level-2 class-feat slot, applies Battle Font and exact prepared slots, resolves skill and static-grant fallbacks, then reruns with zero pending steps | `.wayfinder-smoke/class-archetype-final-2`, class-archetype tests | release |
...
- Battle Creed is the only registered class-archetype profile. Other class archetypes remain intentionally hidden until their replaced features, forced feats, nested choices, and subsystem changes have dedicated evidence.
