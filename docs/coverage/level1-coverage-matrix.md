...
- All-class live smoke evidence on 2026-05-11: `.wayfinder-smoke/all-class-l1-l5-attempt-3` applied every class in `D:\Source\pf2e\packs\pf2e\classes` from blank level 1 to target level 5 in Foundry / PF2E 8.1.1, with 27 passing cases, zero duplicate source IDs, zero rerun pending steps, and no classified/manual failures.
