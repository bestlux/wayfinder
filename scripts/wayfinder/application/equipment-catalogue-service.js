...
function normalizeIndexedBrowsePriceFacts(system, traitsRoot, itemType, price) {
    ...
    if (!Array.isArray(rules) || rulesCanAlterOwnPrice(rules, itemType))
        return null;
    ...
    if (traits.has("modular"))
        return null;
    if (traits.has("infused") ||
        (system.temporary !== undefined && system.temporary !== null && system.temporary !== false)) {
        return null;
    }
    const otherTags = traitsRoot.otherTags;
    if (otherTags !== undefined && otherTags !== null && !Array.isArray(otherTags))
        return null;
    if (stringArray(otherTags).some((tag) => tag.toLowerCase() === "shoddy"))
        return null;
...
function hasConfiguredPricing(system, itemType) {
    ...
    if (grade !== undefined && grade !== null && grade !== "commercial")
        return true;
