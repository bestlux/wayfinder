...
function hasConditionalFallbackSkillTrainingText(descriptionText: string): boolean {
  return (
    /\bif you would automatically become trained in (?:one of those skills|[A-Za-z][A-Za-z' -]+)\b/i.test(
      descriptionText
    ) &&
